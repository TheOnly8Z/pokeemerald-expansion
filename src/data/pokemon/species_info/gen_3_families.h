...
#define RALTS_FAMILY_TYPE2 (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_PSYCHIC)
    ...
    [SPECIES_SPINDA] =
    {
        .baseHP        = 80, // 60 + 20
        .baseAttack    = 80, // 60 + 20
        .baseDefense   = 80, // 60 + 20
        .baseSpeed     = 80, // 60 + 20
        .baseSpAttack  = 80, // 60 + 20
        .baseSpDefense = 80, // 60 + 20
        .types = MON_TYPES(TYPE_NORMAL),
        .catchRate = 255,
        ...
        .eggCycles = 15,
        .friendship = STANDARD_FRIENDSHIP,
        .growthRate = GROWTH_MEDIUM_SLOW, //GROWTH_FAST,
    ...
    [SPECIES_LUVDISC] =
    {
        .baseHP        = 93, // 43 + 50
        .baseAttack    = 30, // 30
        .baseDefense   = 95, // 55 + 40
        .baseSpeed     = 103, // 97 + 5
        .baseSpAttack  = 75, // 40 + 35
        .baseSpDefense = 95, // 65 + 30
        .types = MON_TYPES(TYPE_WATER),
        .catchRate = 225,
        ...
        .eggCycles = 20,
        .friendship = STANDARD_FRIENDSHIP,
        .growthRate = GROWTH_MEDIUM_FAST, // GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_2),
        .abilities = { ABILITY_SWIFT_SWIM, ABILITY_FRIEND_GUARD, ABILITY_HYDRATION },
        .bodyColor = BODY_COLOR_PINK,
