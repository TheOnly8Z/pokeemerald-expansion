static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_SHUIYUN_TOWN_INTRO_BOAT - 1] = {MAP_GROUP(SHUIYUN_TOWN_INTRO_BOAT), MAP_NUM(SHUIYUN_TOWN_INTRO_BOAT), 8, 7},
    [HEAL_LOCATION_JIANGSHEN_LAKE - 1] = {MAP_GROUP(JIANGSHEN_LAKE), MAP_NUM(JIANGSHEN_LAKE), 52, 8},
};
