...
const struct TrainerClass gTrainerClasses[TRAINER_CLASS_COUNT] =
{
    ...
    [TRAINER_CLASS_AQUA_LEADER] = { _("AQUA LEADER"), 30, BALL_MASTER },
    ...
    [TRAINER_CLASS_MAGMA_LEADER] = { _("MAGMA LEADER"), 30, BALL_MASTER },
    ...
    [TRAINER_CLASS_SCIENTIST] = { _("SCIENTIST"), 30, BALL_MASTER },
};
